...
import head from './UpDown-Bald-Head_Animation 2_0.png';
import techguy from './tech.jpg';
import teacherguy from './teacher.jpg';
import bossguy from './boss.jpg';
import marketgirl from './marketing.jpg';
...
class App extends Component {
    ...
    ////////////////////////////////
    // STATE A RÉÉCRIRE AVEC DES PROPRIÉTÉS DE NIV1 UNIQUEMENT
    // week, labels, evoData, segData
    ////////////////
    ...
    goToNextWeek = event => {
        ...
        this.setState({
            ...
            selected_kpi: 'visits',
            key: 'first',
            seoCourse: "Welcome back to the Website Analysis.",
            seoConclusion: "Please, select a KPI on the right panel to analyze it on the charts below.",
            kpiTextDefTag: '',
            kpiTextToDoTag: '',
            kpiTextDef: "",
        ...
        console.log(this.state.evoData);
